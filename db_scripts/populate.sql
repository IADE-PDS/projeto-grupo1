...
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (1,'Moamba 250g', 'Ginguba/Amendoim torrada moída', 'imagens/moamba_16_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (2,'Fuba de bombó 3kg', 'Farinha de mandioca, 1Kg', 'imagens/FubaDeBombo.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (3,'Oleo de palma 1L', 'Azeite de dendê, 1L', 'imagens/OleoDePalma.png', 'Sim');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (4,'Farinha musseque 1kg', 'Farinha de mandioca torrada', 'imagens/FarinhaMusseque.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (5,'Mucua 2kg', 'Fruto do embondeiro', 'imagens/mukua_15_11zon.png', 'Sim');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (6,'Muteta 300g', 'Semente de abobora moída', 'imagens/muteta_14_11zon.png', 'Sim');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (7,'Bagre fumado 1kg', 'Bagre seco defumado', 'imagens/bagreFumado_13_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (8,'Carne seca 1kg', 'Carne de vaca com gordura seca', 'imagens/carneSeca_12_11zon.png','Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (9,'Gimboa 500g', ' Folha da gimboa', 'imagens/gimboa_11_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (10,'Kizaca 3kg', 'Folha de mandioca triturada', 'imagens/kizacaMonte.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (11,'Rama de batata 400g', 'Folha da batata doce', 'imagens/ramaDeBatata_10_11zon.png', 'Sim');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (12,'Fuba de milho 3kg', 'Farinha de milho', 'imagens/FubaDeMilho.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (13,'Banana pão 1kg', 'Variedade de banana de cerca 30cm', 'imagens/bananaPao_9_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (14,'Catato 500g', 'Largata que vive no topo das palmeiras', 'imagens/catato.png.jpg', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (15,'Dendem 500g', 'Fruto do dendezeiro', 'imagens/Dendem.png', 'Sim');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (16,'Ginguba 1kg', 'Ginguba/Amendoim ', 'imagens/ginguba_8_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (17,'Paracuca 500g', 'Ginguba/Amendoim torrado enrolado em açucar', 'imagens/paracuca_7_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (18,'Sape-Sape 1kg', 'Fruto que pertence a familia das anonáceas', 'imagens/SapeSape_6_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (19,'Carambola 1kg', 'Fruto da caramboleira', 'imagens/carambola_5_11zon.png', 'Sim');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (20,'Tamarindo 400g', 'Fruto da tamarineira', 'imagens/moamba_16_11zon.png','Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (21,'Maboque 1kg', 'Fruto do maboqueiro', 'imagens/moamba_16_11zon.png', 'Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (22,'Loengo 1kg', 'Fruto roxo proximo ao preto', 'imagens/moamba_16_11zon.png','Null');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (23,'Cana de Açucar 2kg', 'Fruto roxo proximo ao preto', 'imagens/CanaDeAcucar.png', 'Sim');
insert into produto (prod_id,prod_nome, descricao, img_url, predef) values (24,'Ginguba 1kg', 'Fruto roxo proximo ao preto', 'imagens/ginguba_8_11zon.png', 'Null');
